...
print("c = "*string(c)*"\n");
print("d = "*string(d)*"\n");
print("weak_opt = "*string(objective_value(model_w))*"\n");
print("weak_opt_LP = "*string(objective_value(model_w_LP))*"\n");
print("strong_opt = "*string(objective_value(model_s))*"\n");
print("strong_opt_LP = "*string(objective_value(model_s_LP))*"\n");
### ABSOLUTE GAPS
print("weak_GAP_abs = "*string(objective_value(model_w)-objective_value(model_w_LP))*"\n");
print("strong_GAP_abs = "*string(objective_value(model_s)-objective_value(model_s_LP))*"\n");
### RELATIVE GAPS
print("weak_GAP_rel = "*string(objective_value(model_w_LP)/objective_value(model_w))*"\n");
print("strong_GAP_rel = "*string(objective_value(model_s_LP)/objective_value(model_s))*"\n");
